...
class MANGOS_DLL_SPEC Unit : public WorldObject
{
    public:
        ...
        uint32 SpellDamageBonus(Unit *pVictim, SpellEntry const *spellProto, uint32 damage, DamageEffectType damagetype, uint32 stack = 1, bool applyMods = true);
        ...
        void CalcAbsorbResist(Unit *pVictim, SpellSchoolMask schoolMask, DamageEffectType damagetype, const uint32 damage, uint32 *absorb, uint32 *resist, SpellEntry const* hSpellProto = NULL);
