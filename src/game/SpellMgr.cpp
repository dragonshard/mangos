...
uint32* SpellMgr::LoadWarlockPetLevelupSpellMapInit(uint32 *pet_spell_db_count)
{
    uint32 *pet_spell_data = NULL;
    *pet_spell_db_count = 0;

    //                                                 0               1
    QueryResult *result = WorldDatabase.PQuery("SELECT creature_entry, spell_id FROM pet_levelspell");
...
void SpellMgr::LoadWarlockPetLevelupSpellMap()
{
    ...
    warlock_pet_spell_data = LoadWarlockPetLevelupSpellMapInit(&warlock_pet_spell_count);
